...
from ai_trackdown_pytools.core.models import (
    ...
    BaseModel, StatusType, PriorityType, IssueType, PRType
)
...
class TestIssueModel:
    ...
    def test_issue_type_validation(self):
        ...
        # Valid issue types
        for issue_type in ["bug", "feature_request", "enhancement", "task", "documentation"]:
...
class TestPRModel:
    ...
    def test_pr_type_validation(self):
        ...
        # Valid PR types
        for pr_type in ["feature", "bugfix", "hotfix", "refactor", "breaking_change", "documentation"]:
