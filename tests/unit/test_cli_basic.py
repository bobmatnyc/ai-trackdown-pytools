...
class TestCLICommands:
    ...
    def test_edit_command(self, mock_editor, mock_task_manager_class, 
                         mock_project, runner):
        """Test edit command."""
        # Success case
        mock_project.exists.return_value = True
    ...
    def test_validate_command(self, mock_validator_class, mock_task_manager_class,
                            mock_validate_task, mock_validate_project, 
                            mock_project, runner):
...
class TestMainCallback:
    ...
    @patch('os.chdir')
    @patch('os.getcwd')
    def test_main_callback_with_project_dir(self, mock_getcwd, mock_chdir, 
                                          mock_config, mock_logging, runner):
    ...
    @patch('ai_trackdown_pytools.cli.setup_logging')
    @patch('ai_trackdown_pytools.cli.Config')
    def test_main_callback_with_config_file(self, mock_config_class, mock_logging, runner):
