...
from ai_trackdown_pytools.utils.templates import (
    TemplateManager, TemplateEngine, TemplateError,
    load_template, render_template, list_templates,
    validate_template, get_template_variables
)
...
""")
    ...
    def test_get_template_variables(self):
        ...
        expected_vars = {"id", "title", "description", "status", "priority", "assignees", "tags"}
        assert expected_vars.issubset(set(variables))
...
"""
        ...
        variables = {"id": "TSK-0001", "title": "Custom Task", "custom_field": "custom_value"}
...
"""
        ...
        expected_vars = {
            "id", "title", "priority", "nested", "show_conditional", 
            "conditional_value", "items", "user", "admin_content"
        }
