...
class TestSystemUtils:
    ...
    @patch('ai_trackdown_pytools.core.config.Config')
    def test_get_system_info(self, mock_config_class, mock_git_utils, mock_cwd,
                           mock_machine, mock_system, mock_python_version):
...
class TestHealthChecks:
    ...
    def test_check_health(self, mock_git, mock_config, mock_deps, mock_python):
        ...
        mock_deps.return_value = {"status": True, "message": "All dependencies installed"}
    ...
    def test_check_project_health(self, mock_tasks, mock_config, mock_structure, mock_exists):
