...
class TestTaskManager:
    ...
    def test_list_tasks_by_status(self):
        ...
        in_progress_task = task_manager.create_task({"title": "In Progress Task", "status": "in_progress"})
        completed_task = task_manager.create_task({"title": "Completed Task", "status": "completed"})
    ...
    def test_list_tasks_by_assignee(self):
        ...
        alice_task = task_manager.create_task({"title": "Alice Task", "assignees": ["alice"]})
        bob_task = task_manager.create_task({"title": "Bob Task", "assignees": ["bob"]})
        shared_task = task_manager.create_task({"title": "Shared Task", "assignees": ["alice", "bob"]})
    ...
    def test_list_tasks_by_tag(self):
        ...
        urgent_bug = task_manager.create_task({"title": "Urgent Bug", "tags": ["bug", "urgent"]})
    ...
    def test_search_tasks(self):
        ...
        task_manager.create_task({
            ...
            "description": "Fix typos in user guide"
        })
