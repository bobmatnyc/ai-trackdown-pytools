...
class TemplateManager:
    ...
    def apply_template(self, template_type: str, name: str, 
                      project_path: Path, variables: Optional[Dict[str, Any]] = None,
    ...
    def install_templates(self, source: str, template_name: Optional[str] = None,
